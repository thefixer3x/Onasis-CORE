...
2. **Credential Scrubbing**
   - Replaced all 11 instances with `[REDACTED_SUPABASE_SERVICE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY
...
- [ ] GitHub Actions
  - Update `SUPABASE_SERVICE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY
...
# Verification
git diff --stat
grep -c "\[REDACTED_SUPABASE_SERVICE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY
```
