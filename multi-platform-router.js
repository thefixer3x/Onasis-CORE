...
if (!SD_GHOST_VPS_URL || !SD_GHOST_SUPABASE_URL || !ONASIS_SUPABASE_URL || !JWT_SECRET) {
  logger.error('Missing required environment variables. Please check your .env file.');
  logger.error('Required: SD_GHOST_VPS_URL, SD_GHOST_SUPABASE_URL, ONASIS_SUPABASE_URL, JWT_SECRET');
  process.exit(1);
}
