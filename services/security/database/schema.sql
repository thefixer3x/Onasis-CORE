...
SET search_path TO security_service, extensions, public;
...
CREATE TABLE memory_entries (
    ...
    user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    organization_id UUID NOT NULL REFERENCES organizations(id) ON DELETE CASCADE,
    embedding extensions.vector(1536), -- OpenAI ada-002 embedding dimension
...
CREATE INDEX idx_memory_entries_embedding ON memory_entries USING ivfflat (embedding extensions.vector_cosine_ops)
WITH (lists = 100);
