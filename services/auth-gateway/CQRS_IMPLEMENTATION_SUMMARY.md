...
**Verify:**
```bash
psql "$DATABASE_URL" -c "\dt auth_gateway.events"
psql "$DATABASE_URL" -c "\dt auth_gateway.outbox"
```
...
**Verify:**
```bash
psql "postgresql://postgres.mxtsdgkwzjzlttpotole:***@..." -c "\dt public.auth_events"
psql "postgresql://postgres.mxtsdgkwzjzlttpotole:***@..." -c "\df public.apply_auth_event"
psql "postgresql://postgres.mxtsdgkwzjzlttpotole:***@..." -c "\d public.auth_users_view"
```
...
psql "postgresql://postgres.mxtsdgkwzjzlttpotole:***@..." -c "
