 ...
 */
export function oauthSecurityHeaders(req, res, next) {
    ...
    res.setHeader('Content-Security-Policy', "default-src 'none'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; connect-src 'self'; form-action 'self'");
 ...
 */
export function validateReferer(req, res, next) {
