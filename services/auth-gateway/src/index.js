...
import { redisClient, closeRedis } from './services/cache.service.js';
// Import routes
...
app.post('/register', express.json(), async (req, res) => {
    try {
        const { client_name, redirect_uris, grant_types = ['authorization_code'], response_types = ['code'], scope = 'memories:read memories:write mcp:connect', token_endpoint_auth_method = 'none', } = req.body;
        ...
        const isLocalhost = redirect_uris.every((uri) => uri.startsWith('http://localhost') ||
