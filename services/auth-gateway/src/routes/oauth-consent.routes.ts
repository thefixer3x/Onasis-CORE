...
router.get('/consent', (req, res) => {
  ...
  res.setHeader(
    ...
    `default-src 'self'; script-src 'self' 'nonce-${nonce}' https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline'; connect-src 'self' ${SUPABASE_URL} https://*.supabase.co; img-src 'self' data: https:;`
  )
