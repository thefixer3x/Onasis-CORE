...
function validateCredentials(): void {
  if (!env.MAIN_SUPABASE_URL || !env.MAIN_SUPABASE_SERVICE_ROLE_KEY) {
    ...
    console.error('  - MAIN_SUPABASE_URL:', env.MAIN_SUPABASE_URL ? '✓ SET' : '✗ NOT SET')
    console.error('  - MAIN_SUPABASE_SERVICE_ROLE_KEY:', env.MAIN_SUPABASE_SERVICE_ROLE_KEY ? '✓ SET' : '✗ NOT SET')
    console.error('')
    ...
    console.error('  MAIN_SUPABASE_URL="https://mxtsdgkwzjzlttpotole.supabase.co"')
  ...
  console.log('  Target: Main DB (MAIN_SUPABASE_URL)')
}
