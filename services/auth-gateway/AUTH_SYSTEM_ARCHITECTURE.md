...
│                                                                          │
│  IMPORTANT: DATABASE_URL=postgresql://<user>:<password>@<host>:<port>/<db>
└─────────────────────────────────────────────────────────────────────────┘
                                    │
                                    │ Direct Postgres (DATABASE_URL=postgresql://<user>:<password>@<host>:<port>/<db>
                                    ▼
┌─────────────────────────────────────────────────────────────────────────┐
...
│                                                                          │
│  Accessed via:                                                           │
│  └── Edge function DATABASE_URL=postgresql://<user>:<password>@<host>:<port>/<db>
└─────────────────────────────────────────────────────────────────────────┘
```
...
curl -X POST "https://mxtsdgkwzjzlttpotole.supabase.co/functions/v1/batch-sync-users" \
  ...
  -H "X-Webhook-Secret: <WEBHOOK_SECRET=REDACTED_WEBHOOK_SECRET
```
...
**Access**: Via Auth-Gateway edge functions (DATABASE_URL=postgresql://<user>:<password>@<host>:<port>/<db>
...
const pool = new postgres.Pool(DATABASE_URL=postgresql://<user>:<password>@<host>:<port>/<db>
