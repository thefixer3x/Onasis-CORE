...
//    - Environment: MAIN_SUPABASE_URL, MAIN_SUPABASE_SERVICE_ROLE_KEY
...
if (env.MAIN_SUPABASE_URL && env.MAIN_SUPABASE_SERVICE_ROLE_KEY) {
  _supabaseUsers = createClient(
    env.MAIN_SUPABASE_URL,
    env.MAIN_SUPABASE_SERVICE_ROLE_KEY,
    {
      auth: {
        autoRefreshToken: false,
        persistSession: false,
  ...
  console.warn('⚠️  WARNING: MAIN_SUPABASE_URL or MAIN_SUPABASE_SERVICE_ROLE_KEY not set!')
  ...
  console.warn('   - SUPABASE_URL (Auth-Gateway DB): ' + (env.SUPABASE_URL ? 'SET' : 'NOT SET'))
  console.warn('   - MAIN_SUPABASE_URL (Users DB): NOT SET')
  console.warn('')
