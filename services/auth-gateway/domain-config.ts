 ...
 */
export const ORGANIZATIONAL_SUBDOMAINS: SubdomainConfig[] = [
    {
        subdomain: 'dashboard',
        name: 'Main Dashboard',
        type: 'admin',
 ...
 */
export const getActiveSubdomains = (): string[] => {
 ...
 */
export const getOAuthRedirectUris = (): string[] => {
    return ORGANIZATIONAL_SUBDOMAINS
 ...
 */
export const generateCorsOrigins = (): string => {
    const basePatterns = [
        '*.lanonasis.com',
        'https://*.lanonasis.com',
 ...
 */
export const isAuthorizedSubdomain = (subdomain: string): boolean => {
    return ORGANIZATIONAL_SUBDOMAINS.some(config =>
        config.subdomain === subdomain && config.status === 'active'
    )
}