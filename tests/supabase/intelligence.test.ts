...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://lanonasis.supabase.co/functions/v1';
...
describe('Intelligence Edge Functions (Direct Supabase)', () => {
  ...
  beforeAll(async () => {
    ...
    const response = await fetch(`${SUPABASE_URL}/memory-create`, {
      method: 'POST',
      headers: {
  ...
  afterAll(async () => {
    // Cleanup test memory
    if (testMemoryId) {
      await fetch(`${SUPABASE_URL}/memory-delete`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-API-Key': TEST_API_KEY,
  ...
  describe('intelligence-health-check', () => {
    it('should return health score and statistics', async () => {
      const response = await fetch(`${SUPABASE_URL}/intelligence-health-check`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-API-Key': TEST_API_KEY,
  ...
  describe('intelligence-suggest-tags', () => {
    it('should suggest tags for content', async () => {
      const response = await fetch(`${SUPABASE_URL}/intelligence-suggest-tags`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-API-Key': TEST_API_KEY,
  ...
  describe('intelligence-find-related', () => {
    it('should find related memories', async () => {
      const response = await fetch(`${SUPABASE_URL}/intelligence-find-related`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-API-Key': TEST_API_KEY,
  ...
  describe('intelligence-extract-insights', () => {
    it('should extract insights from memory context', async () => {
      const response = await fetch(`${SUPABASE_URL}/intelligence-extract-insights`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-API-Key': TEST_API_KEY,
  ...
  describe('intelligence-analyze-patterns', () => {
    it('should analyze memory patterns', async () => {
      const response = await fetch(`${SUPABASE_URL}/intelligence-analyze-patterns`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-API-Key': TEST_API_KEY,
  ...
  describe('intelligence-detect-duplicates', () => {
    it('should handle duplicate detection (may timeout)', async () => {
      ...
      try {
        const response = await fetch(`${SUPABASE_URL}/intelligence-detect-duplicates`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'X-API-Key': TEST_API_KEY,
